...
| ema_wick_reclaim_mnq | futures | MNQ | 3m (EMA200 5m anchor) | 18674.05 (2025+, post-fix realism) | $ | n/a (custom $/trade model) | 910 | n/a | n/a | rr=2;wick>=8 ticks;atr_floor=0.5 ATR14;cost_cap=0.10R;session=all;stop=atr;entry=ob_mid_retest;commission_rt=1.24;slippage_rt=1.00;realism fixes applied (next-bar OB fill, timed exit mark-to-close) | PARTIALLY_TESTED |
