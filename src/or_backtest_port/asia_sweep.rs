...
pub(super) fn reversal_spec() -> ReversalSpec {
    ReversalSpec {
        pre_start: NaiveTime::from_hms_opt(0, 0, 0).unwrap(),
        pre_end: NaiveTime::from_hms_opt(2, 0, 0).unwrap(),
        trade_start: NaiveTime::from_hms_opt(2, 0, 0).unwrap(),
        trade_end: NaiveTime::from_hms_opt(7, 0, 0).unwrap(),
